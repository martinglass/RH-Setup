# Edit this to choose which Github repo to use (see wget below) ...
$githubUser = "martinglass"
#$githubUser = "Aaronsss"
...
then
  ...
  then
    ...
    echo "Downloading install script"
      wget https://github.com/$githubUser/RH-Setup/archive/refs/heads/main.zip
      unzip -q main.zip
